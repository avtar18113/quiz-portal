        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-form-title"
                    style="background-image: url(https://quiz.concepttc.com/OnlineExamination/assets/images/aocr-header-image.webp);background-size: 100% 100%;">
                    <!-- <div class="login100-form-title">
				<img src="login-ui/images/bg-01.jpg"> -->
                </div>
                <form method="#" id="examineeLoginFrm" class="login100-form validate-form">
					...
					<!--<div class="container-login100-form-btn" align="right">-->
					<!--	<button type="button" class="login100-form-btn" data-toggle="modal" data-target="#exampleModal">-->
					<!--		Login-->
					<!--	</button>-->
					<!--</div>-->
                </form>
